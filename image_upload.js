...
async function predict() {
    ...
    switch (prediction[0].className) {
        case "Prada":
            resultTitle = "절제된 고급스러움, <br> 인간 프라다";
            resultExplain =
            ...
            break;
        case "Chanel":
            resultTitle = "클래식한 트렌디함, <br> 인간 샤넬";
            resultExplain =
            ...
            break;
        case "Diol":
            resultTitle = "단아하지만 강인한 매력, <br> 인간 디올";
            resultExplain =
        ...
        case "Fendi":
            resultTitle =
                "부드러움과 강인함, 자신감 넘치는 애티튜드. <br> 인간 펜디";
            resultExplain =
